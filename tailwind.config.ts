...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: { display: ['Oswald', 'IBM Plex Mono', 'sans-serif'], mono: ['IBM Plex Mono', 'Courier New', 'monospace'] },
      ...
      animation: { 'accordion-down': 'accordion-down 0.2s ease-out', 'accordion-up': 'accordion-up 0.2s ease-out', 'fade-in': 'fade-in 0.4s ease-out both', 'scale-in': 'scale-in 0.25s ease-out both', 'scan': 'scan 6s linear infinite' }
    }
  },
